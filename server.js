...
if (process.env.NODE_ENV !== 'production') app.use(morgan('dev')); else app.use(morgan('combined'));
...
app.use(express.static(path.join(__dirname, 'public'), { index: false, maxAge: process.env.NODE_ENV === 'production' ? '1d' : 0 }));
app.use('/admin', express.static(path.join(__dirname, 'public', 'admin'), { index: false, maxAge: process.env.NODE_ENV === 'production' ? '1d' : 0 }));
...
app.get('/admin/analytics.html', (req, res) => res.sendFile(path.join(__dirname, 'public', 'admin', 'analytics.html')));
app.get('/admin/settings.html', (req, res) => res.sendFile(path.join(__dirname, 'public', 'admin', 'settings.html')));

app.use('/admin', (req, res) => res.status(404).sendFile(path.join(__dirname, 'public', 'admin', 'login.html')));
